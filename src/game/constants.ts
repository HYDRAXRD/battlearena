...
export const ENEMIES: EnemyConfig[] = [
  ...
  },
  {
    ...
    maxHp: 160, attack: 15, defense: 5, dodgeRate: 0.2, attackSpeed: 1700,
    tokenReward: 200, scoreValue: 700,
  },
  {
    id: 'bonk',
    name: 'Bonk',
    subtitle: 'Bonk First, Ask Later',
    maxHp: 180, attack: 18, defense: 6, dodgeRate: 0.1, attackSpeed: 1600,
    specialThreshold: 0.4, specialMultiplier: 2.5, tokenReward: 250, scoreValue: 900,
  },
  {
    id: 'pengu',
    name: 'Pengu',
    subtitle: 'Arctic Frost Striker',
    maxHp: 200, attack: 16, defense: 10, dodgeRate: 0.12, attackSpeed: 1900,
    healRate: 8, tokenReward: 300, scoreValue: 1100,
  },
  {
    id: 'floki',
    name: 'Floki',
    subtitle: 'Viking of the Mempool',
    maxHp: 220, attack: 20, defense: 8, dodgeRate: 0.15, attackSpeed: 1500,
    specialThreshold: 0.35, specialMultiplier: 3.5, tokenReward: 350, scoreValue: 1400,
  },
  {
    id: 'dog',
    name: 'Dog',
    subtitle: 'Good Boy, Bad Odds',
    maxHp: 250, attack: 22, defense: 12, dodgeRate: 0.18, attackSpeed: 1400,
    healRate: 10, tokenReward: 400, scoreValue: 1700,
  },
  {
    id: 'trump',
    name: 'Trump',
    subtitle: 'Make Crypto Great Again',
    maxHp: 300, attack: 25, defense: 15, dodgeRate: 0.1, attackSpeed: 1200,
    specialThreshold: 0.25, specialMultiplier: 4, tokenReward: 500, scoreValue: 2000,
  },
];

export const ABILITIES: Ability[] = [
  { id: 'liquidity-blast', name: 'Liquidity Blast', icon: '\u{1F4A5}', baseDamage: 25, healAmount: 0, energyCost: 30, cooldownMs: 5000, headIndex: 0 },
  { id: 'scalability-strike', name: 'Scalability Strike', icon: '\u26A1', baseDamage: 40, healAmount: 0, energyCost: 45, cooldownMs: 8000, headIndex: 1 },
  { id: 'atomic-swap', name: 'Atomic Swap', icon: '\u{1F504}', baseDamage: 15, healAmount: 20, energyCost: 35, cooldownMs: 6000, headIndex: 2 },
];
